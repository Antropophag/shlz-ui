...
- [x] 8.4 Run post-discovery route conformance, independent review, component completion gates, and delivery guards; reroute any material scope expansion, then commit and push the task branch and open an unmerged PR for the user's merge decision.
