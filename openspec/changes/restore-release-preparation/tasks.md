...
- [x] 1.1 Complete strict OpenSpec validation and route/requirements/baseline receipts before changing the repository permission.
- [x] 1.2 Enable the existing preparation workflow's repository permission, retain read defaults, retry the failing run and verify the resulting coherent, unmerged version PR.
