...
- [ ] 4.2 Record the live corporate GitLab publication/resume/exact-consumer/promotion/rollback exercise as a required separate post-merge activation change, and verify the implementation PR performs no external registry mutation and cannot report the pipeline active.
