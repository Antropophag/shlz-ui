...
export const reportCardMarkup = ({
  ...
  <article class="shlz-report-card${source ? " shlz-report-card--source" : ""}${muted ? " shlz-report-card--muted" : ""}${fluid ? " shlz-report-card--fluid" : ""}" data-component-audit-id="${auditId}">
...
<article id="card-with-action-demo">
  ...
  <div class="shlz-card-composition-grid">
    <article class="shlz-card-with-action shlz-card-with-action--source" data-component-audit-id="card-with-action-showcase-source" aria-labelledby="card-action-title">
...
<article id="report-card-demo">
  ...
  <div class="shlz-card-composition-grid">
    ${reportCardMarkup({ auditId: "report-card-showcase-default", eyebrow: "Заявки", title: "Обработано за месяц", value: "128", meta: "+12 к прошлому месяцу", link: "#consumer-validation", source: true })}
    ${reportCardMarkup({ auditId: "report-card-showcase-muted", eyebrow: "Испытания", title: "Требуют внимания", value: "7", meta: "Обновлено сегодня", muted: true, source: true })}
...
<article id="cover-demo">
  ...
  <div class="shlz-cover shlz-cover--source" data-component-audit-id="cover-showcase-default" aria-labelledby="cover-title">
