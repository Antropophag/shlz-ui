...
const componentAuditRoots = [
  ...
  ["#typography-compatibility .shlz-table", "button-typography-table"],
  [
  ...
  [
    "[data-consumer-workspace] [data-workspace-empty]",
