...
<section id="icons" class="shlz-icon-catalog"><h2>Icons <span class="shlz-evidence" data-kind="FACT">FACT · normalized authoritative icon manifest</span></h2><p>${manifest.length} canonical logical icons. Compatibility aliases are shown as metadata and are not separate canonical icons.</p><div data-icon-catalog-content></div></section></section>
