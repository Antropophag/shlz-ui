...
<section id="typography-compatibility" class="shlz-major-section shlz-type-stress" data-shlz-visual-addition>
  ...
  <div class="shlz-type-stress__samples" data-shlz-type-stress>
    ...
    <div class="shlz-dropdown" data-component-audit-id="dropdown-typography-stress"><div class="shlz-dropdown__menu shlz-type-stress__dropdown" role="menu"><button class="shlz-dropdown__item" role="menuitem">Регистрация заявки на проведение испытаний</button><button class="shlz-dropdown__item" role="menuitem">0123456789</button></div></div>
