...
const snackbarCountdown = (number) =>
  `<span class="shlz-notification__source-countdown" data-snackbar-number="${number}" aria-hidden="true"><svg viewBox="0 0 64 58"><path fill-rule="evenodd" clip-rule="evenodd" d="${snackbarProgressPaths[number]}" fill="currentColor"></path></svg><span>${number}</span></span>`;
