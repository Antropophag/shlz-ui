...
const implementations = {
  ...
  table: `<table class="shlz-table" style="inline-size:440px"><thead class="shlz-table__head"><tr><th class="shlz-table__cell">Name</th><th class="shlz-table__cell" aria-sort="ascending"><span class="shlz-table__heading"><span>State</span><span class="shlz-table__actions">${tableSorter("Sort by state")}${tableFilter("Filter by state", 'aria-pressed="true"')}</span></span></th></tr></thead><tbody><tr><td class="shlz-table__cell">Content</td><td class="shlz-table__cell"><span class="shlz-status">Active</span></td></tr><tr><td class="shlz-table__cell shlz-table__cell--visual-hover"><input class="shlz-table__editor" value="Editing"></td><td class="shlz-table__cell shlz-table__empty"></td></tr></tbody></table>`,
...
export const fidelityMarkup = [
  ...
  },
  {
    ...
    fidelity: "MEDIUM",
    deviations:
      "The source Component Set is named Dropdown. All 52 structured variants remain mapped; the executable single-select composes its closed shell with a SHLZ listbox surface while search, multiselect and status remain diagnostic axes.",
  },
  {
    id: "checkbox",
    title: "Checkbox",
