...
For requirements-gated changes, read and enforce `docs/requirements-elicitation.md` before execution planning/apply and whenever implementation exposes material ambiguity.
...
- On new material user-owned ambiguity, persist the unresolved decision and invalidate OpenSpec linkage before asking; update OpenSpec from the answer and re-check readiness before resuming the affected packet
