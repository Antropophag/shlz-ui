...
The prop type rejects `iconOnly: true` with `size: "xs"`. JavaScript inputs combining them render the supported `sm` icon-only size, including SSR and reactive updates.
