...
| P1       | Browser and assistive-technology support | PR #83 adds seven shared smoke workflows in Chromium, Firefox and WebKit. The bounded Windows/NVDA matrix and execution conditions are recorded in [browser and screen-reader evidence](accessibility-support.md); browser smoke is not AT evidence or a general conformance claim. |
