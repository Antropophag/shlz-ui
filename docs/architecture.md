...
- Typography uses an explicit system-sans semantic token because the SVG evidence cannot recover the exact family; browser-default serif is never an implicit fallback.
