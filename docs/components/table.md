...
Cells are 50px high with source-backed 8px inline inset and 2px bottom divider. Observed 40/48/54/110/140/167px widths are intrinsic or composition geometry, not public width enums. Editable cells accept a consumer-owned native control; commit/cancel/data mutation are `CONSUMER_DEFINED`.
