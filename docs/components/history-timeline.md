...
<ol class="shlz-history-timeline" aria-label="История изменений">
  <li class="shlz-history-timeline__period">Сегодня</li>
  <li class="shlz-history-timeline__entry">
...
DOM order is authoritative; the component never parses or sorts dates. Period labels are list items so their place in the supplied sequence remains explicit. Marker and rail are decorative. Compose native actions and existing attachment primitives inside entry content.
