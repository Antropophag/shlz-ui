...
const installFixture = async (page, markup) => {
  ...
  await page.addStyleTag({
    content: `
      ...
      .wave2-tooltip { position: relative; inset: auto; display: block; }
      .wave2-tooltip[data-placement^="top"] .shlz-tooltip__arrow { inset-block-end: -4px; inset-inline-start: calc(50% - 4px); }
      .wave2-tooltip[data-placement^="bottom"] .shlz-tooltip__arrow { inset-block-start: -4px; inset-inline-start: calc(50% - 4px); }
      .wave2-tooltip[data-placement="left"] .shlz-tooltip__arrow { inset-block-start: calc(50% - 4px); inset-inline-end: -4px; }
      .wave2-tooltip[data-placement="right"] .shlz-tooltip__arrow { inset-block-start: calc(50% - 4px); inset-inline-start: -4px; }
      .wave2-tooltip[data-placement$="start"] .shlz-tooltip__arrow { inset-inline-start: 18px; }
      .wave2-tooltip[data-placement$="end"] .shlz-tooltip__arrow { inset-inline: auto 18px; }
      .wave2-link-grid { display: grid; grid-template-columns: repeat(4, max-content); gap: 32px; align-items: center; }
    `,
  });
